# 3. Создать класс, в классе хранить лист словарей (как у меня в коде пример с подключениями
# - можете придумать что-нибудь своё, например в словарях данные людей будут или ещё что-нибудь)
